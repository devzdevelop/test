...
function dpp_user_redirecting($plugin) {
    if (plugin_basename(__FILE__) == $plugin) {
        wp_safe_redirect(admin_url('tools.php?page=duplicate-pp'));
        exit;
    }
}
...
if ( ! function_exists( 'dci_plugin_duplicate_pp' ) ) {
    function dci_plugin_duplicate_pp() {
        ...
        wp_register_style('dci-sdk-duplicate_pp', plugins_url('dci/assets/css/dci.css', __FILE__), array(), '1.2.1', 'all');
        wp_enqueue_style('dci-sdk-duplicate_pp');
        ...
        dci_dynamic_init( array(
            ...
            'plugin_msg'  => '
                <p>Thank you for using <strong>Duplicate PP</strong>! We hope you enjoy using it. If you love <strong>Duplicate PP</strong>, please consider leaving us a 5-star review on <a href="https://wordpress.org/support/plugin/duplicate-pp/reviews/#new-post" target="_blank">WordPress</a> to help us spread the word. </p>
